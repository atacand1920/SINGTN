...
@IBDesignable open class AKPropertySlider: UIView {
    ...
    public init(property: String,
                ...
                frame: CGRect = CGRect(x: 0, y: 0, width: 540, height: 60),
    ...
    func drawFlatSlider(currentValue: CGFloat = 0, initialValue: CGFloat = 0, minimum: CGFloat = 0, maximum: CGFloat = 1, propertyName: String = "Property Name", currentValueText: String = "0.0") {
        ...
        let bgColor = self.backgroundColor ??  UIColor(red: 0.9, green: 0.9, blue: 0.9, alpha: 1)
        bgColor.setFill()
        sliderAreaPath.fill()
        ...
        let nameLabelFontAttributes = [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: fontSize), NSAttributedString.Key.foregroundColor: textColor, NSAttributedString.Key.paragraphStyle: nameLabelStyle] as [NSAttributedString.Key : Any]
        ...
        let valueLabelFontAttributes = [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: fontSize), NSAttributedString.Key.foregroundColor: textColor, NSAttributedString.Key.paragraphStyle: valueLabelStyle] 
