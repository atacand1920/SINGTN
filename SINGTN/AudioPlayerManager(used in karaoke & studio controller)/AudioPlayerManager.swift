...
final class AudioPlayerManager: NSObject {
	...
	private func setupPlayer(with audioVisualizationTimeInterval: TimeInterval) {
		if let player = self.audioPlayer {
            ...
            if player.isPlaying {
                NotificationCenter.default.post(name: .audioPlayerManagerDidStartPlaying, object: self)
            }
...
extension Notification.Name {
    ...
    static let audioPlayerManagerDidStartPlaying =
    Notification.Name("AudioPlayerManagerDidStartPlaying")
}
