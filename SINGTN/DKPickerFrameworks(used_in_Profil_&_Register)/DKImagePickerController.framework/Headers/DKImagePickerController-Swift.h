...
@interface DKAssetGroupDetailVC : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate, UIGestureRecognizerDelegate>
- (void)viewDidLoad;
...
@interface DKImageExtensionPhotoCropper : DKImageBaseExtension <TOCropViewControllerDelegate>
...
- (DKAssetGroupDetailVC * _Nonnull)makeRootVC SWIFT_WARN_UNUSED_RESULT;
- (void)presentCamera;
...
- (void)dismissCameraWithIsInline:(BOOL)isInline;
- (void)dismiss;
- (void)done;
