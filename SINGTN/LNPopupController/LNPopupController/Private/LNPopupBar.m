...
- (void)_updateProgressViewWithStyle:(LNPopupBarProgressViewStyle)style
{
    ...
    -(void)_updateProgressViewColor:(UIColor *)color
    {
...
- (void)setProgressColor:(UIColor *)systemTintColor
    {
        if (_progressViewColor != systemTintColor)
        {
        [self _updateProgressViewColor:systemTintColor];
        }
        _progressViewColor = systemTintColor;
