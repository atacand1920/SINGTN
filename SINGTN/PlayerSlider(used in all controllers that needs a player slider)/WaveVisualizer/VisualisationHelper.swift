...
class VisualisationHelper {
    ...
    func updateWaveWithBuffer(_ buffer: UnsafePointer<UnsafeMutablePointer<Float>>, withBufferSize bufferSize: UInt32, withNumberOfChannels numberOfChannels: UInt32, leftWave: EZAudioPlot, rightWave: EZAudioPlot) {
