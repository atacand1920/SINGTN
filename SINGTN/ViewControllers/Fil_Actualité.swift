...
/**
 this controller is responsible of the Friends News view
 */
class File_Actualité : UIViewController, UITableViewDelegate,UITableViewDataSource {
    /**
    ...
    var FirstLoad = 0
    /**
    this is contains a default message if our tableview.count == 0
     */
  ...
  /* @objc func imgTapped(sender: UITapGestureRecognizer) {
    ...
    let updateLike        = NSNotification.Name(rawValue:"updateLike")
     let UpdateLikeFromCell        = NSNotification.Name(rawValue:"UpdateLikeFromCell")
     let CommentPush        = NSNotification.Name(rawValue:"CommentPush")
    let CommentOpen        = NSNotification.Name(rawValue:"CommentOpen")
